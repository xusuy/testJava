...
public class DateHelper {
    ...
    public static final String DATE_PATTERN_6 = "yyyy年MM月";
    ...
    public static final SimpleDateFormat DAY_FORMAT_6 = new SimpleDateFormat(DATE_PATTERN_6);
    ...
    public static final String dateTransType(String time) throws ParseException {
        ...
        if ("日期格式正确".equals(msg)) {
            ...
            throw new RuntimeException("导入时间的" + msg);
        }
    }
    ...
    //2019-01-01 转换成 2019年01月
    public static String dateFormat2YearMonth(String date) throws ParseException {
        String res = "";
        if (date != null && !"".equals(date)) {
            res = DAY_FORMAT_6.format(DAY_FORMAT.parse(date));
        }
        return res;
    }
     ...
     * @return
     */
    public synchronized static int calcDays(Date firstDate, Date secondDate) {
     ...
     * 获取两个日期月数差
     */
    public static int calcMonths(String firstDate, String secondDate) throws ParseException {
        Date fDate = string2Date(firstDate, YEAR_MONTH_PATTERN_2);
        Date sDate = string2Date(secondDate, YEAR_MONTH_PATTERN_2);
        return (int) (Math.abs(fDate.getTime() - sDate.getTime()) / (1000 * 60 * 60 * 24)) / 30 + 1;
    }
     ...
     * @param: endDate   结束日期
     **/
    public synchronized static boolean compareDate(SimpleDateFormat format, String startDate, String endDate) {
     ...
     * 获取指定月末
     */
    public synchronized static String getLastDayOfMonth(String date) throws ParseException {
     ...
     * 获取指定月初
     */
    public synchronized static String getFirstDayOfMonth(String date) throws ParseException {
        Date date1 = DAY_FORMAT.parse(date);
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date1);
        calendar.set(Calendar.DAY_OF_MONTH, calendar.getMinimum(Calendar.DATE));
     ...
     * @return
     */
    public synchronized static boolean isInDate(String time, String beginDateStr, String endDateStr) throws ParseException {
        boolean result = false;
        // 需要比较的时间
    ...
    public static String validate(String dateStr) {
        ...
        if (dateStr.matches("[0-9]+") && dateStr.length() == 8) {
            ...
            throw new RuntimeException("请传入指定日期格式，如：20190302");
        }
        // 最基本的检查格式 begin
    ...
    //两日期相差多少月
    public static int MonthCompare(String startDate, String endDate) throws ParseException {
        Date sDate = DAY_FORMAT.parse(startDate);
        Date eDate = DAY_FORMAT.parse(endDate);
